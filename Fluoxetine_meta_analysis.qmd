...
row.names(effect_fluoxetine_meta) <- NULL
 ...
 effect_fluoxetine_meta$trt <- factor(effect_fluoxetine_meta$trt, levels = c("Ivermectin", "Favipiravir", "Fluoxetine", "Molnupiravir", "Remdesivir", "Nirmatrelvir"))
...
writeLines(sprintf("Effects of fluoxetine: %s [95CrI: %s - %s]",
                   round(formatter(effect_fluoxetine_meta[effect_fluoxetine_meta$i == 9 & effect_fluoxetine_meta$trt == "Fluoxetine",]$med),2),
                   round(formatter(effect_fluoxetine_meta[effect_fluoxetine_meta$i == 9 & effect_fluoxetine_meta$trt == "Fluoxetine",]$L95),2),
                   round(formatter(effect_fluoxetine_meta[effect_fluoxetine_meta$i == 9 & effect_fluoxetine_meta$trt == "Fluoxetine",]$U95),2)
))
```
